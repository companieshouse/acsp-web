...
updateRoutes.post(urls.UPDATE_BUSINESS_ADDRESS_LOOKUP, correspondenceAddressAutoLookupValidator("registeredOfficeAddress"), businessAddressAutoLookupController.post);
