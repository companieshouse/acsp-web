...
export const SOLE_TRADER_MANUAL_CORRESPONDENCE_ADDRESS = `${BASE_COMMON_URL}/correspondence-address-manual/capture-correspondence-address-manual`;
export const SOLE_TRADER_CORRESPONDENCE_ADDRESS_CONFIRM = `${BASE_COMMON_URL}/correspondence-address-confirm/correspondence-address-confirm`;
...
export const AML_BODY_DETAILS = `${BASE_COMMON_URL}/aml-body-details/aml-body-details`;
