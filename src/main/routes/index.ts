...
import {
    ...
    , companyInactiveController, whatIsTheBusinessNameController, whatIsYourRoleController
} from "../controllers";
...
routes.get("/sole-trader/what-is-your-role", whatIsYourRoleController.get);
routes.get("/limited/what-is-your-role", whatIsYourRoleController.get);
