...
import {
    BASE_URL, UNINCORPORATED_CORRESPONDENCE_ADDRESS_CONFIRM, UNINCORPORATED_ADDRESS_CORRESPONDANCE_SELECTOR,
...
export const get = async (req: Request, res: Response, next: NextFunction) => {
    ...
    res.render(config.AUTO_LOOKUP_ADDRESS, {
        previousPage: addLangToUrl(BASE_URL + UNINCORPORATED_ADDRESS_CORRESPONDANCE_SELECTOR, lang),
