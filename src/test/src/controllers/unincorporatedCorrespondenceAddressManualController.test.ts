...
import { BASE_URL, UNINCORPORATED_CORRESPONDENCE_ADDRESS_MANUAL } from "../../../main/types/pageURL";
...
describe("GET" + UNINCORPORATED_CORRESPONDENCE_ADDRESS_MANUAL, () => {
    it("should return status 200", async () => {
        await router.get(BASE_URL + UNINCORPORATED_CORRESPONDENCE_ADDRESS_MANUAL).expect(200);
