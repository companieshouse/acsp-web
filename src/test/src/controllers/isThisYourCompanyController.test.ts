...
import { LIMITED_IS_THIS_YOUR_COMPANY, BASE_URL, LIMITED_WHAT_IS_THE_COMPANY_AUTH_CODE } from "../../../main/types/pageURL";
...
describe("POST " + LIMITED_IS_THIS_YOUR_COMPANY, () => {
    it("should redirect to authentication code page for active company", async () => {
        ...
        // expect(redirect).toHaveBeenCalledWith(BASE_URL + LIMITED_WHAT_IS_THE_COMPANY_AUTH_CODE)
    });
});
