...
import { BASE_URL, UNINCORPORATED_BUSINESS_ADDRESS_LIST } from "../../../main/types/pageURL";
...
describe("POST" + UNINCORPORATED_BUSINESS_ADDRESS_LIST, () => {
    it("should return status 400 after incorrect data entered", async () => {
        const res = await router.post(BASE_URL + UNINCORPORATED_BUSINESS_ADDRESS_LIST).send({ correspondenceAddress: "" });
