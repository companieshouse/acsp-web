...
import { BASE_URL, UNINCORPORATED_BUSINESS_ADDRESS_MANUAL_ENTRY } from "../../../main/types/pageURL";

jest.mock("@companieshouse/api-sdk-node");
const router = supertest(app);

describe("GET" + UNINCORPORATED_BUSINESS_ADDRESS_MANUAL_ENTRY, () => {
    it("should return status 200", async () => {
        await router.get(BASE_URL + UNINCORPORATED_BUSINESS_ADDRESS_MANUAL_ENTRY).expect(200);
