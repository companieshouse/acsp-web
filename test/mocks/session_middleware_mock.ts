...
import { COMPANY, COMPANY_DETAILS, USER_DATA, SUBMISSION_ID, PREVIOUS_PAGE_URL, ADDRESS_LIST, ACSP_DETAILS, ACSP_DETAILS_UPDATED, NEW_AML_BODY } from "../../src/common/__utils/constants";
