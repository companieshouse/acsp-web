...
describe("updateWithTheEffectiveDateAmendment", () => {
    ...
    it("should add dateOfChange to NEW_AML_BODY and clean up session data for UPDATE_ADD_AML_SUPERVISOR", () => {
