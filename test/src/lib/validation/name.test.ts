import nameErrorManifest from "../../../../src/lib/utils/error_manifests/name";
import { firstNameChecker, lastNameChecker, middleNameChecker } from "../../../../src/lib/validation/name";
