...
import { AML_MEMBERSHIP_NUMBER, UPDATE_ACSP_DETAILS_BASE_URL, UPDATE_AML_START_DATE, UPDATE_YOUR_ANSWERS } from "../../../../src/types/pageURL";
...
describe("POST " + UPDATE_ACSP_DETAILS_BASE_URL + AML_MEMBERSHIP_NUMBER, () => {
    it("should return status 302 after redirect for valid input, ", async () => {
        ...
        expect(res.header.location).toBe(UPDATE_ACSP_DETAILS_BASE_URL + UPDATE_AML_START_DATE + "?lang=en");
    });
