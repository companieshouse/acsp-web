...
import { BASE_URL, LIMITED_SELECT_AML_SUPERVISOR, LIMITED_WHAT_IS_YOUR_EMAIL } from "../../../../src/types/pageURL";
...
describe("POST" + LIMITED_WHAT_IS_YOUR_EMAIL, () => {
    ...
    it("should return status 302 after redirect", async () => {
        ...
        const res = await router.post(BASE_URL + LIMITED_WHAT_IS_YOUR_EMAIL).send(formData);
