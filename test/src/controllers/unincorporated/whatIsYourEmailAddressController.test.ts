...
import { BASE_URL, UNINCORPORATED_SELECT_AML_SUPERVISOR, UNINCORPORATED_WHAT_IS_YOUR_EMAIL } from "../../../../src/types/pageURL";
...
describe("GET" + UNINCORPORATED_WHAT_IS_YOUR_EMAIL, () => {
    ...
    it("should return status 200", async () => {
        ...
        const res = await router.get(BASE_URL + UNINCORPORATED_WHAT_IS_YOUR_EMAIL);
...
describe("POST" + UNINCORPORATED_WHAT_IS_YOUR_EMAIL, () => {
    afterEach(() => {
        process.removeAllListeners("uncaughtException");
    });
